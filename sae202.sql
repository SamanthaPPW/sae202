...
ALTER TABLE utilisateurs ADD COLUMN is_confirmed TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE utilisateurs ADD COLUMN confirmation_token VARCHAR(64) DEFAULT NULL;
